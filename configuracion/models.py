...
class Configuracion(Base):
    ...
    porcentaje_horas_extras = models.DecimalField(max_digits=5, decimal_places=2, default=Decimal('0.25'), null=False, blank=False, verbose_name="Porcentaje Horas Extras")
