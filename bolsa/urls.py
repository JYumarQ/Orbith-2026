...
urlpatterns = [
    ...
    path('updt_aspir/<int:pk>/', login_required(views.AspiranteUpdateView.as_view()), name='updt_aspir'),
    path('del_aspir/<int:pk>/', login_required(views.AspiranteDeleteView.as_view()), name='del_aspir'),
